...
export function authenticateUser() {
  const authUrl = `https://api.descope.com/oauth2/v1/apps/agentic/${DESCOPE_PROJECT_ID}/${MCP_SERVER_ID}/authorize?response_type=code&client_id=UDJ0N0NvdjFJTERhYkN1QnJhRmhWbEZzUmwyUDpUUEEzOGZiQXNJVDdrMW5jODRTdkViMnFPaXluNGc=&redirect_uri=http://localhost:3000/callback&scope=google-read+google-send&flow=inbound-apps-user-consent`;
